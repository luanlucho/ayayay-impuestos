...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <ChevronDown
      className={cn(
        "relative top-[1px] ml-1 h-3 w-3 stroke-inherit transition duration-200 group-data-[state=open]:rotate-180"
      )}
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
